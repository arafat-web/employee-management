                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="reviewer_id" class="form-select @error('reviewer_id') is-invalid @enderror" required>
                                ...
                                @foreach($reviewers as $reviewer)
                                    <option value="{{ $reviewer->id }}" {{ (old('reviewer_id', $performance->reviewer_id) == $reviewer->id) ? 'selected' : '' }}>
                                        {{ $reviewer->full_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="review_date" class="form-control @error('review_date') is-invalid @enderror"
                                   value="{{ old('review_date', $performance->review_date) }}" required>
                            @error('review_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="review_period" class="form-select @error('review_period') is-invalid @enderror" required>
                                ...
                                <option value="Q1" {{ old('review_period', $performance->review_period) == 'Q1' ? 'selected' : '' }}>Q1 (Jan-Mar)</option>
                                <option value="Q2" {{ old('review_period', $performance->review_period) == 'Q2' ? 'selected' : '' }}>Q2 (Apr-Jun)</option>
                                <option value="Q3" {{ old('review_period', $performance->review_period) == 'Q3' ? 'selected' : '' }}>Q3 (Jul-Sep)</option>
                                <option value="Q4" {{ old('review_period', $performance->review_period) == 'Q4' ? 'selected' : '' }}>Q4 (Oct-Dec)</option>
                                <option value="Mid-Year" {{ old('review_period', $performance->review_period) == 'Mid-Year' ? 'selected' : '' }}>Mid-Year</option>
                                <option value="Yearly" {{ old('review_period', $performance->review_period) == 'Yearly' ? 'selected' : '' }}>Yearly</option>
                            </select>
                            @error('review_period')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="quality_of_work" class="form-control @error('quality_of_work') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('quality_of_work', $performance->quality_of_work) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="productivity" class="form-control @error('productivity') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('productivity', $performance->productivity) }}" required>
                            @error('productivity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="communication" class="form-control @error('communication') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('communication', $performance->communication) }}" required>
                            @error('communication')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="teamwork" class="form-control @error('teamwork') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('teamwork', $performance->teamwork) }}" required>
                            @error('teamwork')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="initiative" class="form-control @error('initiative') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('initiative', $performance->initiative) }}" required>
                            @error('initiative')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="attendance_punctuality" class="form-control @error('attendance_punctuality') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('attendance_punctuality', $performance->attendance_punctuality) }}" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="overall_rating" class="form-control @error('overall_rating') is-invalid @enderror"
                                   min="1" max="5" step="0.1" value="{{ old('overall_rating', $performance->overall_rating) }}" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="strengths" class="form-control @error('strengths') is-invalid @enderror"
                                      rows="3">{{ old('strengths', $performance->strengths) }}</textarea>
                            @error('strengths')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="areas_for_improvement" class="form-control @error('areas_for_improvement') is-invalid @enderror"
                                      rows="3">{{ old('areas_for_improvement', $performance->areas_for_improvement) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="goals" class="form-control @error('goals') is-invalid @enderror"
                                      rows="3">{{ old('goals', $performance->goals) }}</textarea>
                            @error('goals')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="comments" class="form-control @error('comments') is-invalid @enderror"
                                      rows="3">{{ old('comments', $performance->comments) }}</textarea>
                            @error('comments')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <a href="{{ route('performance.show', $performance) }}" class="btn btn-secondary">
