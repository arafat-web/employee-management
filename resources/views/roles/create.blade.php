                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="name" class="form-label">Role Name (System) <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="{{ old('name') }}" required
                                   placeholder="e.g., manager, supervisor">
                            <small class="text-muted">Use lowercase with underscores (e.g., hr_manager)</small>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="can_manage_roles" name="can_manage_roles" value="1" {{ old('can_manage_roles') ? 'checked' : '' }}>
